...
import java.net.*;
	...
	private void init() throws MalformedURLException {
        ...
        // LATAAVALLA RIVILLÄ
        imageLabel.setIcon(new ImageIcon(new URL("http://kartat.lounaispaikka.fi/wms/maakuntakaava?version=1.1.1&service=WMS&request=GetMap&layers=mk_aluevaraus&srs=EPSG:4326&bbox=22.1,60.4,22.3,60.5&width=700&height=500&format=image/png&styles=")));
